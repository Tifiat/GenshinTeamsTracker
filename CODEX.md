...
- `run_workspace/pvp/`: isolated backend-only PvP v0 foundation for deck JSON,
  ...
  only a PvP placeholder workspace/right-dock policy with no real draft board or
  controller wiring.
