...
- Future AppShell tasks:
  ...
  - next Account/Data setup tasks: auto-open the Account page when the account database is empty; later onboarding may highlight the Account action. A compact Support/Donate header action, fuller settings area, and fuller Account-page support area remain optional future directions, not current UI;
