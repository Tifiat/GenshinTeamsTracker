...
- [x] оверлей иконок
  ...
  2. [ ] приступим после того как я подтвержу, что п1 выполнен. красное выделение не скрывается вьюпортом, еще и накладывается поверх других сайд айконов. А это значит, что ты вообще не на тот слой их разместил. Это выделение должно в работать поверх иконок оружия и подчиняться той же логике, то есть скрываться вьюпортом и не накладываться\находиться на слое под сайд айконами и их бейджами. 
